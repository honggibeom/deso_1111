...
@WebServlet(name = "noticelist", urlPatterns = { "/admin/notice/list" })
public class list extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(admin==null){
			...
			//상품리스트
			List<Notice> list = ns.list(kind,keyword,startRow,endRow);
			
			// 전체 게시글 가져오기 위한 ( 전체 글 개수 세는 것)
			int listCount = ns.listCount(kind,keyword,startRow,endRow);
