...
@WebServlet(name = "adminBoardList", urlPatterns = { "/admin/board/list" })
public class list extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(admin==null){
			...
			//상품리스트
			List<Board> list = bs.list(mode,kind,keyword,startRow,endRow);
			
			int listCount = bs.count(mode,kind,keyword,startRow,endRow);
			...
			RequestDispatcher dis = request.getRequestDispatcher("/admin/board/list.jsp");
